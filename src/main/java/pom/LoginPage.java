...
public class LoginPage {
    ...
    @Step("Вход в аккаунт на странице авторизации")
    ...
    @Step("Клик по кнопке входа из конструктора бургеров")
    ...
    @Step("Клик по кнопке входа со страниц восстановления пароля и регистрации")
